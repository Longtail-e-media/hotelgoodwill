...
*/
	...
	// Carousel Slider
	// ----------------
		$(".carousel-slider .swiper-button-next").on('click', function(event) {
			event.preventDefault();
		...
		$(".carousel-slider .swiper-button-prev").on('click', function(event) {
			event.preventDefault();
	...
	// Sliced Slider
	// ----------------
		$(".sliced-slider .swiper-button-next").on('click', function(event) {
			event.preventDefault();
		...
		$(".sliced-slider .swiper-button-prev").on('click', function(event) {
			event.preventDefault();
