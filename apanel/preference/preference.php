        ...
        <form action="" class="col-md-12 center-margin" id="Preference_frm">
            ...
            <div class="form-row">
                ...
                <div class="form-input col-md-10 uploader2 <?php echo !empty($PrefeRow->logo_upload) ? "hide" : ""; ?>">
                    ...
                    <label>
                    <small>Image Dimensions (500px X 500px)</small>
                        </small>
                    </label>
                </div>
                <!-- Upload user image preview -->
...
<div class="form-row">
                ...
                <?php if (!empty($PrefeRow->footer_logo)): ?>
                    <div class="col-md-2" id="removeSavedimg10">
                        <div class="infobox info-bg">
                            <div class="button-group" data-toggle="buttons">
                            <span class="float-left">
                                <?php
                                if (file_exists(SITE_ROOT . "images/preference/" . $PrefeRow->footer_logo)):
                                    $filesize = filesize(SITE_ROOT . "images/preference/" . $PrefeRow->footer_logo);
                                    echo 'Size : ' . getFileFormattedSize($filesize);
                                endif;
                                ?>
                            </span>
                            ...
                            <img src="<?php echo IMAGE_PATH . 'preference/thumbnails/' . $PrefeRow->footer_logo; ?>"
                                 style="width:100%"/>
                                 <input type="hidden" name="imageArrayname10" value="<?php echo $PrefeRow->footer_logo; ?>" class=""/>
                        </div>
                    </div>
                <?php endif; ?>
                <div class="form-input col-md-10 uploader10 <?php echo !empty($PrefeRow->footer_logo) ? "hide" : ""; ?>">
                    <input type="file" name="footer_logo" id="footer_logo" class="transparent no-shadow">
                    <label>
                       Footer Logo
                       <small>Image Dimensions (500 px X 500px)</small>
                    </label>
                </div>
                <!-- Upload user image preview -->
                <div id="preview_Image10"></div>
            </div>
<!-- footer logo end -->
            <div class="form-row">
                <div class="form-label col-md-2">
            ...
            <div class="form-row">
                ...
                <div class="form-input col-md-10 uploader5 <?php echo !empty($PrefeRow->gallery_upload) ? "hide" : ""; ?>">
                    ...
                    <label>
                    <small>Image Dimensions (1920 px X 1000px)</small>
                    </label>
                </div>
                <!-- Upload user image preview -->
