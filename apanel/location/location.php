          ...
          <!--  <div class="form-row">
           ...
           <!-- <div class="form-row">
            ...
            <div class="form-row">
                ...
                <div class="form-input col-md-20">
                    <input placeholder="Room Reservation No." class="col-md-6" type="text" name="whatsapp_a"
                           id="whatsapp_a"
            ...
            <div class="form-row">
                ...
                <div class="form-input col-md-20">
                    <input placeholder="Event Reservation No." class="col-md-6" type="text" name="event_reservation"
                           id="event_reservation"
                           value="<?php echo !empty($locationRow->event_reservation) ? $locationRow->event_reservation : ""; ?>">
                </div>
            </div>
            <div class="form-row">
                <div class="form-label col-md-2">
                ...
                <div class="form-input col-md-20">
                    <input placeholder="Google Map Link" class="col-md-6" type="text" name="google_map"
                           id="google_map"
                           value="<?php echo !empty($locationRow->google_map) ? $locationRow->google_map : ""; ?>">
                </div>
            </div>
            <div class="form-row">
                <div class="form-label col-md-2">
