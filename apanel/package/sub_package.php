            ...
            <form action="" class="col-md-12 center-margin" id="subpackage_frm">
                ...
                <div class="form-row add-image">
                    ...
                    <div class="form-input col-md-10 uploader">
                        ...
                        <label>
                        <small>Image Dimensions (1920px X 1000px)</small>
                    </label>
                    </div>
                ...
                <div class="form-row add-image">
                    ...
                    <div class="form-input col-md-10 uploader">
                        <input type="file" name="subpackage_upload" id="subpackage_upload"
                               ...
                               <label>
                               <small>Image Dimensions (1180px X 900px)</small>
                    </label>
                    </div>
                    <!-- Upload user image preview -->
                ...
                <?php if ($pkg->type == 1) { ?>
                    ...
                    <!-- <div class="form-row">
                        ...
                        <div class="form-input col-md-6">
                            <input placeholder="Bathroom" class="col-md-3 validate[length[0,3]]" type="text"
                                   name="view" id="view"
