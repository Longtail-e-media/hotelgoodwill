...
$imglink= $siteRegulars->other_upload ;
if(!empty($imglink)){
...
if (!empty($tstRec)) {
    ...
    foreach ($tstRec as $tstRow) {
        ...
        for ($i = 0; $i < $tstRow->type; $i++){
            ...
            $rating.='<span class="icon-fa-star-o"></span>';
        }
        $restst .= '';
        $restst .= '
        <!-- owl item -->
...
$jVars['module:testimonial_img'] = $img;
...
$tstRec = Testimonial::get_alltestimonial();
if(!empty($tstRec)) {
	$restslider.='<div class="swiper-wrapper">';
        ...
        foreach($tstRec as $tstRow) {
            ...
            $restslider.='<article class="swiper-slide">
    <div class="inner">
        <div class="stars">
          '.$rating.'
        </div>
        ...
        <div class="cite">
            <span class="guest">'.$tstRow->name.'</span>
            <span class="line"></span>
            <span class="source">'.$tstRow->via_type.'</span>
        </div>
    </div>
</article>';
        }
...
$jVars['module:testiSlider'] = $restslider;
?>